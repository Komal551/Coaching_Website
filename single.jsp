    ...
    <div class="container-fluid bg-light position-relative shadow">
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0 px-lg-5">
            <a href="" class="navbar-brand font-weight-bold text-secondary" style="font-size: 50px;">
                ...
                <span class="text-primary">Disha Institute</span>
            </a>
                ...
                <div class="bg-light p-5">
                    ...
                    <form action="BlogServlet" method ="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input name ="user_url" type="url" class="form-control" id="website">
                        </div>

                        <div class="form-group">
                            <label for="message">Message *</label>
                            <textarea name ="user_message"id="message" cols="30" rows="5" class="form-control"></textarea>
                        </div>
    ...
    <div class="container-fluid bg-secondary text-white mt-5 py-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                <a href="" class="navbar-brand font-weight-bold text-primary m-0 mb-4 p-0" style="font-size: 40px; line-height: 40px;">
                    <i class='fas fa-book-reader' style='font-size:36px'></i>
                    <span class="text-white">Disha Institute </span>
                </a>
        ...
        <div class="container-fluid pt-5" style="border-top: 1px solid rgba(23, 162, 184, .2);;">
            <p class="m-0 text-center text-white">
                &copy; <a class="text-primary font-weight-bold" href="#"> All Rights Reserved. Designed
                by
                <a class="text-primary font-weight-bold" href="https://htmlcodex.com">Arvind Sahu</a> ,
                <a class="text-primary font-weight-bold" href="https://htmlcodex.com">Komal Srivastava</a> &
                <a class="text-primary font-weight-bold" href="https://htmlcodex.com">Devansh Srivastava</a>
